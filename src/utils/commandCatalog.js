...
const SECTIONS = [
  ...
  { id: 'inventory', title: 'Economie et Equipement', module: 'items', order: 50 },
...
const COMMAND_MODULE_OVERRIDES = {
  ...
  boahancook: 'nsfw',
  desactivatebot: null,
  // Commandes "gold" affichees dans la section Economie mais gated par le module xp
  // (comportement conserve apres regroupement des categories).
  gold: 'xp',
  work: 'xp',
  vendre: 'xp',
  miner: 'xp',
