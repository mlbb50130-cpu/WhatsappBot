...
module.exports = {
  ...
  async execute(sock, message, args, user, isGroup, groupData, reply) {
    ...
    try {
      ...
      const selectedFile = ImageRotationSystem.getNextImage(imageTracker, 'rengokudemon', files);
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('🔥 𝔗𝔈𝔐𝔊𝔬𝔲 🔥', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('🔥 𝔗𝔈𝔑𝔊𝔞𝔨𝔯 𝔦𝔬𝔧𝔞 🔥', [{ label: '📺 Type', value: 'Personnage' }])
      });
