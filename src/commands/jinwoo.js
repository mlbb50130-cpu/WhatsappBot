  ...
  async execute(sock, message, args, user, isGroup, groupData) {
    ...
    try {
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('🌙 𝔍𝔦𝔫𝔴𝔬𝔬 🌙', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('🌙 𝔍𝔦𝔫𝔴𝔞𝔬 🌙', [{ label: '📺 Type', value: 'Personnage' }])
      });
