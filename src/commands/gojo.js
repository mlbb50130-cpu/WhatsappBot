  ...
  async execute(sock, message, args, user, isGroup, groupData, reply) {
    ...
    try {
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('👁️ 𝔊𝔒𝔍𝔒 👁️', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('👁️ 𝔊𝔒𝔍𝔒 👁️', [{ label: '📺 Type', value: 'Personnage' }])
      });
