  ...
  async execute(sock, message, args, user, isGroup, groupData) {
    ...
    try {
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('🐍 𝔅𝔬𝔞 𝔥𝔞𝔯𝔴𝔞𝔤𝔦 🐍', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('🐍 𝔅𝔬𝔞 𝔥𝔞𝔫𝔠𝔬𝔧𝔨 🐍', [{ label: '📺 Type', value: 'Personnage' }])
      });
