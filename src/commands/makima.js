  ...
  async execute(sock, message, args, user, isGroup, groupData, reply) {
    ...
    try {
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('🔴 𝔐𝔞𝔦𝔦𝔟𝔞 🔴', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('🔴 𝔐𝔞𝔫𝔬𝔪𝔞 🔴', [{ label: '📺 Type', value: 'Personnage' }])
      });
