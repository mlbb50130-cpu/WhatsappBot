  ...
  async execute(sock, message, args, user, isGroup, groupData) {
    ...
    try {
      ...
      await sock.sendMessage(senderJid, {
        image: imageBuffer,
        caption: isGroup ? MessageFormatter.elegantBox('🛻 𝔜𝔞𝔫𝔦 🛻', [{ label: '✨ Récompense', value: allowXp ? '+2 XP' : '🚫 Limite atteinte (10/jour)' }]) : MessageFormatter.elegantBox('🛻 𝔜𝔩𝔪𝔦 🛻', [{ label: '📺 Type', value: 'Personnage' }])
      });
